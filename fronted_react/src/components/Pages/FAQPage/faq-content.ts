...
export const faqContent: FaqContent[] = [
    ...
    },
    {
        ...
        answer: 'Yes, poll must be a question with at least 2 answers, and each answer should be unique.',
    },
    {
    ...
    {
        question: 'Would my poll results include unregistered users, which answer my poll at the past?',
        answer: 'No, the poll results are based on active users, and will update automatically if a user was unregistered. So, only relevant and current information is in the results',
    },
    {
    ...
    },
    {
        ...
        answer: 'Well only an admin can register an admin (so you can 🤓), each admin should have a unique name.',
    },
    {
        question: `What is Cors Policy and why Chrome might block requests from the server? `,
        answer: 'Honestly, we didn\'t fully understand, and it seems like no one on the web did either. You can try install some chrome extension - Allow CORS: Access-Control-Allow-Origin',
    },
    {
